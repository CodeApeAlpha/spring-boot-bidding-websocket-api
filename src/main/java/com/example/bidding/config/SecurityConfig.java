...
import com.example.bidding.security.JwtAuthenticationEntryPoint;
import com.example.bidding.security.JwtAuthenticationFilter;
        ...
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(auth ->
                auth
                    ...
                    .requestMatchers("/", "/landing.html", "/landing.css", "/index.html", "/styles.css", "/app.js", "/favicon.ico").permitAll()
